...
std::span<const UnitDef> units::builtins() {
  ...
  static const auto BUILTIN_UNITS = std::to_array<UnitDef>({
    ...
    {.id = "usd", .aliases = {"dollar", "buck"},            .dimension = dimensions::CURRENCY, .family = families::CURRENCY, .decimals = 2},
    {.id = "eur", .aliases = {"euro"},                      .dimension = dimensions::CURRENCY, .family = families::CURRENCY, .decimals = 2},
    {.id = "gbp", .aliases = {"pound", "quid", "sterling"}, .dimension = dimensions::CURRENCY, .family = families::CURRENCY, .decimals = 2},
    {.id = "jpy", .aliases = {"yen"},                       .dimension = dimensions::CURRENCY, .family = families::CURRENCY, .decimals = 0},
    {.id = "cny", .aliases = {"yuan", "renminbi", "rmb"},   .dimension = dimensions::CURRENCY, .family = families::CURRENCY, .decimals = 2},
    {.id = "chf", .aliases = {"franc"},                     .dimension = dimensions::CURRENCY, .family = families::CURRENCY, .decimals = 2},
    {.id = "cad", .aliases = {},                            .dimension = dimensions::CURRENCY, .family = families::CURRENCY, .decimals = 2},
    {.id = "aud", .aliases = {},                            .dimension = dimensions::CURRENCY, .family = families::CURRENCY, .decimals = 2},
    {.id = "nzd", .aliases = {},                            .dimension = dimensions::CURRENCY, .family = families::CURRENCY, .decimals = 2},
    {.id = "hkd", .aliases = {},                            .dimension = dimensions::CURRENCY, .family = families::CURRENCY, .decimals = 2},
    {.id = "sgd", .aliases = {},                            .dimension = dimensions::CURRENCY, .family = families::CURRENCY, .decimals = 2},
    {.id = "twd", .aliases = {},                            .dimension = dimensions::CURRENCY, .family = families::CURRENCY, .decimals = 2},
    {.id = "sek", .aliases = {"krona", "kronor"},           .dimension = dimensions::CURRENCY, .family = families::CURRENCY, .decimals = 2},
    {.id = "nok", .aliases = {"krone", "kroner"},           .dimension = dimensions::CURRENCY, .family = families::CURRENCY, .decimals = 2},
    {.id = "dkk", .aliases = {},                            .dimension = dimensions::CURRENCY, .family = families::CURRENCY, .decimals = 2},
    {.id = "pln", .aliases = {"zloty"},                     .dimension = dimensions::CURRENCY, .family = families::CURRENCY, .decimals = 2},
    {.id = "czk", .aliases = {"koruna"},                    .dimension = dimensions::CURRENCY, .family = families::CURRENCY, .decimals = 2},
    {.id = "huf", .aliases = {"forint"},                    .dimension = dimensions::CURRENCY, .family = families::CURRENCY, .decimals = 0},
    {.id = "ron", .aliases = {"leu", "lei"},                .dimension = dimensions::CURRENCY, .family = families::CURRENCY, .decimals = 2},
    {.id = "try", .aliases = {"lira"},                      .dimension = dimensions::CURRENCY, .family = families::CURRENCY, .decimals = 2},
    {.id = "rub", .aliases = {"ruble", "rouble"},           .dimension = dimensions::CURRENCY, .family = families::CURRENCY, .decimals = 2},
    {.id = "uah", .aliases = {"hryvnia"},                   .dimension = dimensions::CURRENCY, .family = families::CURRENCY, .decimals = 2},
    {.id = "inr", .aliases = {"rupee"},                     .dimension = dimensions::CURRENCY, .family = families::CURRENCY, .decimals = 2},
    {.id = "pkr", .aliases = {},                            .dimension = dimensions::CURRENCY, .family = families::CURRENCY, .decimals = 2},
    {.id = "krw", .aliases = {"won"},                       .dimension = dimensions::CURRENCY, .family = families::CURRENCY, .decimals = 0},
    {.id = "thb", .aliases = {"baht"},                      .dimension = dimensions::CURRENCY, .family = families::CURRENCY, .decimals = 2},
    {.id = "myr", .aliases = {"ringgit"},                   .dimension = dimensions::CURRENCY, .family = families::CURRENCY, .decimals = 2},
    {.id = "idr", .aliases = {"rupiah"},                    .dimension = dimensions::CURRENCY, .family = families::CURRENCY, .decimals = 0},
    {.id = "php", .aliases = {},                            .dimension = dimensions::CURRENCY, .family = families::CURRENCY, .decimals = 2},
    {.id = "vnd", .aliases = {"dong"},                      .dimension = dimensions::CURRENCY, .family = families::CURRENCY, .decimals = 0},
    {.id = "aed", .aliases = {"dirham"},                    .dimension = dimensions::CURRENCY, .family = families::CURRENCY, .decimals = 2},
    {.id = "sar", .aliases = {"riyal"},                     .dimension = dimensions::CURRENCY, .family = families::CURRENCY, .decimals = 2},
    {.id = "ils", .aliases = {"shekel"},                    .dimension = dimensions::CURRENCY, .family = families::CURRENCY, .decimals = 2},
    {.id = "zar", .aliases = {"rand"},                      .dimension = dimensions::CURRENCY, .family = families::CURRENCY, .decimals = 2},
    {.id = "egp", .aliases = {},                            .dimension = dimensions::CURRENCY, .family = families::CURRENCY, .decimals = 2},
    {.id = "ngn", .aliases = {"naira"},                     .dimension = dimensions::CURRENCY, .family = families::CURRENCY, .decimals = 2},
    {.id = "brl", .aliases = {"real", "reais"},             .dimension = dimensions::CURRENCY, .family = families::CURRENCY, .decimals = 2},
    {.id = "mxn", .aliases = {"peso"},                      .dimension = dimensions::CURRENCY, .family = families::CURRENCY, .decimals = 2},
    {.id = "ars", .aliases = {},                            .dimension = dimensions::CURRENCY, .family = families::CURRENCY, .decimals = 2},
    {.id = "clp", .aliases = {},                            .dimension = dimensions::CURRENCY, .family = families::CURRENCY, .decimals = 0},
    {.id = "cop", .aliases = {},                            .dimension = dimensions::CURRENCY, .family = families::CURRENCY, .decimals = 0},
    {.id = "pen", .aliases = {"sol"},                       .dimension = dimensions::CURRENCY, .family = families::CURRENCY, .decimals = 2},
    {.id = "btc", .aliases = {"bitcoin"},                   .dimension = dimensions::CURRENCY, .family = families::CURRENCY, .decimals = 8},
    {.id = "eth", .aliases = {"ether", "ethereum"},         .dimension = dimensions::CURRENCY, .family = families::CURRENCY, .decimals = 8},
  });
  // clang-format on
